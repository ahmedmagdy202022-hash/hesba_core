...
class FirstUiNavigationMapTests(TestCase):
    ...
    def test_dashboard_snapshot_page_renders_hesba_identity_mock(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "120B_DASHBOARD_USE_ASSETS_PACK_V2")
        self.assertContains(response, "لوحة القيادة")
        self.assertContains(response, "hesba/css/dashboard_mock.css")
        self.assertContains(response, "hesba/dashboard/assets/brand/hesba_logo_primary.png")
        self.assertContains(response, "hesba/dashboard/assets/hero/hesba_dashboard_hero_illustration.png")
        self.assertContains(response, "hesba/dashboard/assets/kpi_icons/today_sales.png")
        self.assertContains(response, "hesba/dashboard/assets/quick_actions_existing/01_register_transaction.png")
