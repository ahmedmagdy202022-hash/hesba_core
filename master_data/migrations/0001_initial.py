    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["customer_code"], name="master_data_customer_9b9a52_idx"),
                    models.Index(fields=["name"], name="master_data_name_b3f3ec_idx"),
                    models.Index(fields=["phone"], name="master_data_phone_d42dd4_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["supplier_code"], name="master_data_supplier_869f2c_idx"),
                    models.Index(fields=["name"], name="master_data_name_55f5c2_idx"),
                    models.Index(fields=["phone"], name="master_data_phone_7dfd78_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["item_code"],
                "indexes": [
                    models.Index(fields=["item_code"], name="master_data_item_cod_396a11_idx"),
                    models.Index(fields=["item_name"], name="master_data_item_na_6a927b_idx"),
                    models.Index(fields=["barcode"], name="master_data_barcode_4ded87_idx"),
                ],
            },
        ),
    ]
